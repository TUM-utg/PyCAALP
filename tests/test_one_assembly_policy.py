...
def test_parallel_assembly(_default_kwargs):
...
def test_one_assembly_policy(_default_kwargs):
    """Test the configuration with the one assembly policy."""
    assembly_digraph = create_assembly_digraph(**_default_kwargs)
...
def test_all_cutset_combs(_default_kwargs):
